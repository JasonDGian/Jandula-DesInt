...
class HomeProvider extends ChangeNotifier{
  ...
  Future<void> loadNextPage() async {
    ...
    //final List<VideoPost> newVideos =  videoPosts.map( ( elemento )=> LocalVideoModel().fromJasonMap(elemento).toEntity() ).toList();
    final List<VideoPost> newVideos2 = videoPosts.map( (elemento) => LocalVideoModel.fromJasonMap(elemento).toEntity() ).toList;
